...
class CargoModel extends Model
{
    ...
    /**
     * Obtém os dados de um cargo específico pelo ID
     *
    ...
    public function excluir(int $id): bool
    {
        ...
        $vinculos = parent::projetarEspecifico(
            "SELECT COUNT(*) AS total FROM funcionarios WHERE cargo_id = :id", 
            ['id' => $id], 
            true
        );
    ...
    public function atualizar(array $dados): bool
    {
        ...
        $cargoExistente = parent::projetarEspecifico(
            "SELECT id FROM cargo WHERE nome = :nome AND id != :id", 
            [
                'nome' => trim($dados['nome']),
                'id' => $dados['id']
            ], 
