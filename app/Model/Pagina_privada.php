...
class Pagina_privada extends Model
{
    ...
    public function listar(): array
    {
        try {
            ...
            $_SESSION['msg'] = parent::alertaFalha("Erro ao listar páginas privadas: " . $e->getMessage());
            return [];
        }
    }
    ...
    public function editar($id): array
    {
        ...
        if (parent::formularioValido($this->form_valido)) {
            try {
                ...
                $_SESSION['msg'] = parent::alertaFalha("Erro ao buscar a página privada: " . $e->getMessage());
            }
        }
    ...
    public function cadastrar($dados): void
    {
        ...
        if (parent::existeCamposFormulario($dados, $this->form_obrigatorio, $this->form_obrigatorio_quantidade)) {
            ...
            if (parent::formularioValido($this->form_valido)) {
                try {
                    ...
                    parent::implementar(
                        "INSERT INTO pg_privada (id, nome, dt_registro) VALUES (:id, :nome, :dt_registro)",
                        $dados
                    );

                    $_SESSION['msg'] = parent::alertaSucesso("Página privada cadastrada com sucesso!");
                    return;
                } catch (PDOException $e) {
                    $_SESSION['msg'] = parent::alertaFalha("Erro ao cadastrar página privada: " . $e->getMessage());
                }
            }
        }
        ...
        $_SESSION['msg'] = parent::alertaFalha("Não foi possível cadastrar a página privada. Verifique os dados e tente novamente.");
    }
    ...
    public function excluir($id): void
    {
        ...
        if (parent::formularioValido($this->form_valido)) {
            try {
                ...
                $_SESSION['msg'] = parent::alertaSucesso("Página privada excluída com sucesso!");
                return;
            } catch (PDOException $e) {
                $_SESSION['msg'] = parent::alertaFalha("Erro ao excluir página privada: " . $e->getMessage());
            }
        }
        $_SESSION['msg'] = parent::alertaFalha("Não foi possível excluir a página privada. Verifique os dados e tente novamente.");
    }
        ...
        if (parent::existeCamposFormulario($dados, $this->form_obrigatorio, $this->form_obrigatorio_quantidade)) {
            ...
            if (parent::formularioValido($this->form_valido)) {
                try {
                    ...
                    parent::implementar(
                        "UPDATE pg_privada SET nome = :nome, dt_registro = :dt_registro WHERE id = :id",
                        ['id' => $dados['id'], 'nome' => $dados['nome'], 'dt_registro' => $dados['dt_registro']]
                    );

                    $_SESSION['msg'] = parent::alertaSucesso("Página privada atualizada com sucesso!");
                    return;
                } catch (PDOException $e) {
                    $_SESSION['msg'] = parent::alertaFalha("Erro ao atualizar página privada: " . $e->getMessage());
                }
            }
        }

        $_SESSION['msg'] = parent::alertaFalha("Não foi possível atualizar a página privada. Verifique os campos e tente novamente.");
    }
}
