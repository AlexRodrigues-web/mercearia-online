...
class PaginaInvalida extends Controller
{
    ...
    /**
     * Exibe a página de erro informando que a rota é inválida.
     */
    public function index(): void
    {
        try {
            // Adiciona mensagem de erro na sessão, se o método existir
    ...
    private function viewExiste(string $view): bool
    {
        ...
        // Previne Path Traversal verificando se a view está dentro do diretório esperado
    ...
    private function redirecionar(string $rota): void
    {
        ...
        // Validação extra da URL para evitar Open Redirect
        ...
        // Redirecionamento seguro com código HTTP 302
