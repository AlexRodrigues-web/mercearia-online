...
$customJsPath = '/app/Assets/js/customPaginaPublica.js';
...
<body>
    <div class="container">
        <h1 class="text-center">Gestão de Páginas Públicas</h1>
        <div class="mb-3">
            <a href="/pagina_publica/cadastrar" class="btn btn-success">Cadastrar Nova Página</a>
        </div>
        <table class="table table-bordered table-striped mt-4">
            ...
            <tbody>
                <?php if (!empty($paginas)): ?>
                    <?php foreach ($paginas as $pagina): ?>
                        <tr>
                            ...
                            <td>
                                <a href="/pagina_publica/editar?id=<?= $pagina['id'] ?>" class="btn btn-primary btn-sm">Editar</a>
                                <a href="/pagina_publica/excluir?id=<?= $pagina['id'] ?>" 
                ...
                <?php else: ?>
                    <tr>
                        <td colspan="3" class="text-center">Nenhuma página pública cadastrada.</td>
                    </tr>
                <?php endif; ?>
            </tbody>
        </table>
